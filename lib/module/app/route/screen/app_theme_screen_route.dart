...
import '../controller/app_theme_controller_route.dart';

class AppThemeScreenRoute extends StatelessWidget {
  final AppThemeControllerRoute controller;

  const AppThemeScreenRoute({
    super.key,
